...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        $status  = "disabled";
        $id      = uniqid();
        $q3      = mysqli_query($con, "INSERT INTO quizz VALUES(NULL,'$id','$name','$correct','$wrong','$total','$time', 'NOW()','$status','$category')") or die();
      ...
      if (@$_GET['q'] == 'addimagequiz' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        $status  = "disabled";
        $id      = uniqid();
        $q3      = mysqli_query($con, "INSERT INTO quizz VALUES(NULL,'$id','$name','$correct','$wrong','$total','$time', 'NOW()','$status','$category')");
